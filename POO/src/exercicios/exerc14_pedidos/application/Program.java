package exercicios.exerc14_pedidos.application;
/*Ler os dados de um pedido com N itens (N fornecido pelo usuário). Depois, mostrar um
sumário do pedido conforme exemplo (próxima página). Nota: o instante do pedido deve ser
o instante do sistema: new Date()*/

import exercicios.exerc14_pedidos.entities.Cliente;
import exercicios.exerc14_pedidos.entities.ItensDoPedido;
import exercicios.exerc14_pedidos.entities.Pedido;
import exercicios.exerc14_pedidos.entities.Produto;
